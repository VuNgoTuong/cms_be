...
namespace UserManagement.Controllers.GeneralSetting
{
    ...
    public class ProfileController : ControllerBase
    {
        ...
        [SwaggerResponse((int)HttpStatusCode.OK, Type = typeof(ResponseService<ListResult<ProfileResponse>>))]
        [SwaggerResponse((int)HttpStatusCode.InternalServerError, Type = typeof(ResponseService<ListResult<ProfileResponse>>))]
        public async Task<IActionResult> GetAll([FromBody] PagingParam param)
        {
            ...
            {
                return new ResponseFail<ListResult<ProfileResponse>>().Error(response);
            }
        }
